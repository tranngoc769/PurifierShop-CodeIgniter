            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Cập nhật bài viết</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input class="form-control" id="id" type="text" value="<?= $blog->id?>" disabled readonly required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input class="form-control" id="title" type="text" value="<?= $blog->title?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="summernote"><?= $blog->detail?></div>
                        </div>
                        <div class="card-footer" style="width:100%">
                            <button id="update_blog" type="button" class="btn btn-primary  waves-effect waves-light w-sm" style="width:100%">
